            ...
            <div class="row">
                <div class="col* col-md-12 col-lg-8 sideLeft">
                    ...
                    <div class="row">
                                ...
                                <div class="smBlogBox">
                                    ...
                                    <div class="smBlogBoxBg">
                                        ...
                                        <div class="blogAuthor">
                                            <a >
                                                <figure>
                                                    <img src="it/images/avatar.png" alt="">
                                                </figure>
                        ...
                        @empty
                        <div class="col* col-md-12 col-lg-12 smBlogList">
                            <div class="smBlogBox text-center">
                                No Blog Found.
                            </div>
                            </div>
                        @endforelse
                ...
                <div class="col* col-md-12 col-lg-4 sideRight">
                    <div class="sideBars">
                        ...
                        {{ Form::open(['url' => route('it.blogs.search'), 'method' => 'GET']) }}
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="sideBarInfos">
                                    <a href="{{ route('it.blogs.category', $category->slug) }}">
