...
<div class="container">
    ...
    <div class="justify-content-center">
        ...
        {{ Form::model($category, ['method'=>'put', 'url' => route('category.update', $category->id), 'id' => 'form', 'files' => true]) }}

        @else

        {{ Form::open(['url' => route('category.store'), 'id' => 'form', 'files' => true]) }}
        ...
        <div class="col-md-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{ Form::submit(isset($category) ? 'Update' : 'Create', array('class'=>'btn btn-primary')) }}
