        ...
        <div class="sidebar-content">
            <div class="user">
                <div class="avatar-sm float-left mr-2">
                    <img src="{{ auth()->user()->image ? 'uploads/students/'.auth()->user()->roll_no.'/'.auth()->user()->image : 'backend/images/student-'.auth()->user()->gender.'.jpg' }}" alt="..." class="avatar-img rounded-circle">
                </div>
                <div class="info">
...
<!--                <li class="nav-item">
                ...
                <li class="nav-item {{ ($ss == 'blog' || $ss == 'category' || $ss == 'tag') ? 'active' : '' }}">
                    <a data-toggle="collapse" href="#base" aria-expanded="true">
