                        ...
                        <table border="0" width="600" cellpadding="0" cellspacing="0" class="container" style="width:500px;max-width:500px;background: #eee;padding: 15px;">
                            <tbody>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="col" valign="top" style="padding-left:12px;padding-right:12px;padding-top:18px;padding-bottom:20px">
                                                                        ...
                                                                        @endforeach
                                                                        @isset($actionText)
                                                                        <div class="resetBtn" style="margin: 30px 0;">
                                                                            <a href="{{ $actionUrl }}" style="position: relative;display: inline-block;font-size: 13px;line-height: 28px; color: #fff;font-weight: 600;padding: 7px 20px;background-color: #ff4118;text-transform: uppercase; box-shadow: 0px 0px 26px 1px rgba(244, 65, 23,0.8);;border-radius: 0;text-decoration: none;">{{ $actionText }}</a>
                                                                        </div>
                                                                        @endisset
                                ...
                                <tr>
                                    <td>
                                        @if(isset($settings))
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="force-row" style="width: 100%">
                                            <tbody>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td align="center" style="margin-top: 15px;display: block;">
                                                        <p style="color: #2b2a2a;font-size: 12px;margin: 0;">© {{ $settings->website_name }} All Right Reserved {{ date('Y') }}.</p>
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <td align="center" style="margin-top: 4px;display: block;">
                                                        <p style="color: #2b2a2a;font-size: 12px;margin: 0;">{{ $settings->address }}</p>
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <td align="center" style="margin-top: 10px;display: block;">
                                                        <p style="color: #2b2a2a;font-size: 12px;margin: 0;">You've received this email If you have any enquiries, please do not hesitate to contact us. Thank You!</p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
