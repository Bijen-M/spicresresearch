                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td align="center" style="margin-top: 15px;display: block;">
                                                        <p style="font-family:Nunito Sans,serif;color: #2b2a2a;font-size: 12px;margin: 0;">© {{ $settings->website_name }} All Right Reserved {{ date('Y') }}.</p>
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <td align="center" style="margin-top: 4px;display: block;">
                                                        <p style="font-family:Nunito Sans,serif;color: #2b2a2a;font-size: 12px;margin: 0;">{{ $settings->address }}</p>
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <td align="center" style="margin-top: 10px;display: block;">
                                                        <p style="font-family:Nunito Sans,serif;color: #2b2a2a;font-size: 12px;margin: 0;">You've received this email If you have any enquiries, please do not hesitate to contact us. Thank You!</p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
